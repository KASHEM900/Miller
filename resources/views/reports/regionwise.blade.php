        ...
        <div class="col-md-12">
            <div class="card" id="miller_list">
                <div class="card-header text-2xl">
                    ...
                    <form action="{{ route('exportregionwise') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <input type="hidden" name="division_id"  value="{{$division_id}}">
                        <input type="hidden" name="district_id"  value="{{$district_id}}">
                        <input type="hidden" name="mill_upazila_id"  value="{{$mill_upazila_id}}">

                        <span class="print_hide" style="float: right;">
                            <input type="button" class="btn btn-secondary" value="প্রিন্ট করুন" onclick="printRegionWiseReport()" />
                                        ...
                                        <td>
                                            ...
                                            title="অনুগ্রহ করে  উপজেলা বাছাই করুন">
                                                ...
                                                @foreach($upazillas as $upazilla)
                                                    <option value="{{ $upazilla->upazillaid}}" {{ ( $upazilla->upazillaid == $mill_upazila_id) ?
