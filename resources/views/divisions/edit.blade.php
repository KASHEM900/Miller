...
<div class="card">
    <div class="card-header flex justify-between">
        <span class="text-2xl">বিভাগ হালনাগাদ </span>
    ...
    <form action="{{ route('divisions.update',$division->divid) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-6 col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" name="divid" value="{{$division->divid }}"  class="form-control" placeholder="বিভাগের আইডি">
                </div>
            </div>
        </div>
         <div class="row">
         <div class="col-xs-12 col-sm-6 col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" name="divname" value="{{$division->divname }}" 
                    class="form-control" placeholder="বিভাগের নাম বাংলা">
                </div>
            <div class="form-group">
                <strong>বিভাগ(ইংরেজি নাম):</strong>
                <input type="text" name="name"  value="{{$division->name}}" 
                class="form-control" placeholder="বিভাগের নাম ইংরেজি">
            </div>
            </div>
