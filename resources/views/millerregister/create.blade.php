        ...
        <div class="col-md-12">
            <div id="form_margin" class="form_page">
                ...
                <div id="chalkol_div">
                    ...
                    <form id="millerform" action="{{ route('millerregister.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                                ...
                                <table width="100%" class="mx-2">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><strong>:</strong></td>
                                            <td><input required style="float: left;width: 60%;" type="text" name="birth_date" id="birth_date" class="form-control date" value="{{ old('birth_date') }}" placeholder="একটি তারিখ বাছাই করুন" title="জন্ম তারিখ">
                                        ...
                                        <tr>
                                            ...
                                            <td><strong>:</strong></td>
                                            <td><textarea required maxlength="99" name="mill_address" id="mill_address" class="form-control" title="চালকলের ঠিকানা">{{ old('mill_address') }}</textarea> </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td><strong>:</strong></td>
                                            <td>
                                            <select name="gender" required id="gender" class="form-control" size="1"
                                                title="অনুগ্রহ করে লিঙ্গ বাছাই করুন">
                                        ...
                                        <tr>
                                            ...
                                            <td><strong>:</strong></td>
                                            <td><input maxlength="99" required type="text" name="mother_name" id="mother_name" title=" মাতার নাম" value="{{old('mother_name')}}" class="form-control" placeholder="মাতার নাম বাংলায় লিখুন"></td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td><strong>:</strong></td>
                                            <td><textarea required maxlength="99" name="owner_address" id="owner_address" class="form-control" title="মালিকের ঠিকানা">{{ old('owner_address') }}</textarea></td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td><strong>:</strong></td>
                                            <td><input maxlength="20" required type="text" name="miller_nationality" id="miller_nationality" value="{{ old('miller_nationality', 'বাংলাদেশী') }}"  title=" মালিকের জাতীয়তা"  class="form-control" placeholder="মালিকের জাতীয়তা বাংলায় লিখুন"></td>
                                        </tr>
                                    ...
                                    <table width="100%" class="mx-2">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="text" maxlength="99" name="license_no" id="license_no" class="form-control" value="{{$miller->license_no}}" placeholder="লাইসেন্স নং বাংলায় লিখুন" title="লাইসেন্স নম্বর "></td>
                                ...
                                <div class="card-header flex justify-between">
                                    ...
                                    <tbody><tr>
                                        ...
                                        <td>: </td>
                                            ...
                                            <td><input maxlength="30" type="text" name="millar_p_power_chal" id="millar_p_power_chal" onkeydown="checkbanglainput(event)" placeholder="বাংলায় পুরন করুন" class="form-control" value="{{App\BanglaConverter::en2bn(0, $miller->millar_p_power_chal)}}"> মেট্টিক টন চাল</td>
                            ...
                            @if($option=='form5')
                                ...
                                <fieldset id="boiler_machineries_form">
                                    <div class="card">
                                        <div class="card-header flex justify-between">
                                            <span class="text-xl">
                                            বয়লার এর যন্ত্রপাতির বিবরণ  <span style="color: red;"> * </span>
                                            </span>
                                            <span>
                                                <span style="color: red;"> (*) </span> চিহ্নিত ঘর গুলো অবশ্যই পূরণ করতে হবে
                                            </span>
                                ...
                                <fieldset id="motor_form">
                                    <div class="card">
                                        ...
                                        <table width="100%" class="mx-2">
                                            ...
                                            <tbody><tr>   <td width="50%">মোট ছাটাই ক্ষমতা</td>
                            ...
                            <fieldset id="p_power_form">
                                ...
                                <table width="100%" class="mx-2">
                                    ...
                                    <tbody><tr>
                                        ...
                                        <td><input readonly maxlength="30" type="text" name="millar_p_power_chal" id="millar_p_power_chal" placeholder="" class="form-control" value="{{ old('millar_p_power_chal') }}"> মেট্টিক টন চাল</td>
