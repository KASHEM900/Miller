    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div id="form_margin" class="form_page">
                <h2 align="center">@if($miller->mill_type_id==1) সেমি-অটোমেটিক @elseif($miller->mill_type_id==2) অটোমেটিক  @elseif($miller->mill_type_id==5) হালনাগাদকৃত অটোমেটিক @elseif($miller->mill_type_id==3) হাস্কিং @else মেজর @endif
                চালকলের লাইসেন্সের জন্য আবেদন ফরম</h2>
                <div id="chalkol_div">
                    @if ($errors->any())
                    ...
                    <form id="millerform" action="{{ route('millerregister.update',$miller->miller_id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                                ...
                                <table width="100%" class="mx-2">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><strong>:</strong></td>
                                            <td>
                                                <input readonly required minlength="10" maxlength="17" placeholder="মিল মালিকের এনআইডি লিখুন" style="float: left;width: 60%;" type="number" name="nid_no" id="nid_no" class="form-control" value="{{$miller->nid_no}}" title="মিল মালিকের এনআইডি">
                                        ...
                                        <tr>
                                            ...
                                            <td><strong>:</strong></td>
                                            <td><input required style="float: left;width: 60%;" type="text" name="birth_date" id="birth_date" class="form-control date" value="{{$miller->birth_date}}" placeholder="একটি তারিখ বাছাই করুন" title="জন্ম তারিখ">
                                        ...
                                        <tr>
                                            <td width="50%" style="color: red;">জেলা<span style="color: red;"> * </span> </td>
                                            <td><strong>:</strong></td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td><strong>:</strong></td>
                                            <td><textarea required maxlength="99" name="mill_address" id="mill_address" class="form-control" title="চালকলের ঠিকানা">{{$miller->mill_address}}</textarea> </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td><strong>:</strong></td>
                                            <td><input required maxlength="99" type="text" name="father_name" id="father_name" value="{{$miller->father_name}}" title="পিতার নাম" value="" class="form-control" placeholder="পিতার নাম বাংলায় লিখুন"></td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td><strong>:</strong></td>
                                            <td><textarea required maxlength="99" name="owner_address" id="owner_address" class="form-control" title="মালিকের ঠিকানা">{{$miller->owner_address}}</textarea></td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a target="_blank" href="{{ asset('images/photo_file/large/'.$miller->photo_of_miller) }}">
                                                    <img width="100" height="100" src="{{ asset('images/photo_file/thumb/'.$miller->photo_of_miller) }}" alt="{{$miller->photo_of_miller}}"/>
                                                </a>
                                                @endif
                                                <input class="upload" type="file" name="photo_file">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a target="_blank" href="{{ asset('images/tax_file/large/'.$miller->tax_file_of_miller) }}">
                                                    <img width="100" height="100" src="{{ asset('images/tax_file/thumb/'.$miller->tax_file_of_miller) }}" alt="{{$miller->tax_file_of_miller}}"/>
                                                </a>
                                                @endif
                                                <input class="upload" type="file" name="tax_file">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <input readonly type="text" maxlength="99" name="license_no" id="license_no" class="form-control" value="{{$miller->license_no}}" placeholder="লাইসেন্স নং বাংলায় লিখুন" title="লাইসেন্স নম্বর ">
                                                    @else
                                                    <input type="text" maxlength="99" name="license_no" id="license_no" class="form-control" value="{{$miller->license_no}}" placeholder="লাইসেন্স নং বাংলায় লিখুন" title="লাইসেন্স নম্বর ">
                                                    @endif
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="text" name="date_renewal" id="date_renewal" class="form-control date" value="{{$miller->date_renewal}}" placeholder="একটি তারিখ বাছাই করুন" title="লাইসেন্স যে তারিখ পর্যন্ত বৈধ/নবায়িত"></td>
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="number" name="meter_no" id="meter_no" value="{{$miller->meter_no}}" placeholder="মিটার নং ইংরাজীতে লিখুন" class="form-control" title="মিটার নং"></td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @endif
                                                    <input class="upload" type="file" name="electricity_file">
                                                    <td style="text-align: right;">** JPG/JPEG/PNG আপলোড করুন।</td>
                                                </td>
                                            </tr>
                                ...
                                <div class="card-body mx-2">
                                    ...
                                    <table width="100%" id="param_table">
                                        ...
                                        <tr>
                                            ...
                                            <td><input maxlength="99" type="text" name=" 9_name" id="parameter19_name" class="form-control" value="{{$miller->autometic_miller->parameter19_name}}"></td>
                                ...
                                <div class="card">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><b style="background-color:#0ee60e;"><input maxlength="30" type="text" name="millar_p_power_chal" id="millar_p_power_chal" onkeydown="checkbanglainput(event)" placeholder="বাংলায় পুরন করুন" class="form-control" value="{{App\BanglaConverter::en2bn(0, $miller->millar_p_power_chal)}}"> মেট্টিক টন চাল<b></td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <input class="upload" type="file" name="miller_p_power_approval_file">
                                                <td style="text-align: right;">** JPG/JPEG/PNG আপলোড করুন।</td>
                                            </td>
                                        </tr>
                                            ...
                                            <table>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        @endif
                                                        <input class="upload" type="file" name="boiler_certificate_file">
                                                        <td style="text-align: right;">** ** JPG/JPEG/PNG আপলোড করুন।</td>
                                                    </td>
                                                </tr>
                                ...
                                <fieldset id="chatal_form">
                                    ...
                                    <div class="card-body">
                                            ...
                                            <table width="100%" class="mx-2">
                                                ...
                                                <tbody>
                                                    <tr>   <td width="50%">চাতালের মোট ক্ষেত্রফল<!-- <span style="color: red;"> * </span> -->
                                                    </td>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <table>
                                                ...
                                                <tbody>
                                                    <tr>   <td width="62%">ড্রায়ার সমূহের মোট আয়তন</td>
                                    ...
                                    <div class="card-body">
                                        <table width="100%" class="mx-2">
                                            ...
                                            <tbody><tr>
                                                ...
                                                <td>{{App\BanglaConverter::en2bn(0, $miller->millar_p_power)}} মেট্টিক টন ধান, <b style="background-color:#0ee60e;">{{App\BanglaConverter::en2bn(0, $miller->millar_p_power_chal)}} মেট্টিক টন চাল</b> </td>
                                ...
                                <tbody>
                                    <tr>
                                        <td colspan="3" id="chal_btn_hide"><p align="right">
                                            @if($miller->cmp_status == 0)
                                                <input type="hidden" id="cmp_status" name="cmp_status" value="0">
                                                <input type="hidden" id="miller_status" name="miller_status" value="new_register">

                                                @if(DGFAuth::checkregistration())
                                                <input type="submit" id="chalkol_register" class="btn btn-primary" title="অনুগ্রহ করে  সংরক্ষন করুন" value="সেভ">
                                                <input type="submit" id="chalkol_submit" class="btn btn-primary" title="অনুগ্রহ করে  সংরক্ষন করুন" value="ফাইনাল সাবমিট" onclick="final_submit()">
                                                @endif
                                            @else
                                            <h3 class="label label-success">ফর্মটি ইতোমধ্যেই সাবমিট করা হয়েছে।</h3>
                                            @endif
                                        </p></td>
                                    </tr>
                                </tbody>
