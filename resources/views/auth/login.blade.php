...
<div class="container">
    <div class="row justify-content-center">
        <p style="text-align:center; color: #f0ad4e; font-size:16px;">পরিবর্তন: চালকলের তথ্য এফ পি এস সিস্টেমে পাঠাতে  ফরমে 'Send to FPS' বাটন  চাপুন |</p>
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group row">
                            <label for="email" class="col-md-4 col-form-label text-md-right">লগ-ইন নাম</label>
