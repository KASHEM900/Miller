...
<div class="card">
    <div class="card-header text-2xl">
                    ...
                    অনবায়নকৃত লাইসেন্স সমূহের তালিকা
                    </span>
            </div>
           ...
           <div class="row">
             <form action="{{ route('invalidLicence') }}">
                    @csrf
                    <div class="p-4">
                ...
                <form action="{{ route('inactiveMiller') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="p-4">
                        <table cellpadding="2px">
                            <tbody>
                                <tr>
                                    <td>অনবায়নকৃত সকল চালকল বন্ধ করুন</td>
                                    ...
                                    <input type="submit" name="filter" id="listOfckol" class="btn btn-success" value="সাবমিট"></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
