<fieldset id="auto_p_power_form" style="display:none;">
    <div class="card">
               ...
               <tbody><tr>
                ...
                <tr>
                    <td colspan="3" id="chal_btn_hide"><p align="right" style="margin-top: 20px">
                        ...
                        <input type="submit" id="auto_p_power_submit" class="btn2 btn-primary" title="অনুগ্রহ করে  সংরক্ষন করুন" value="সাবমিট ">
                        <input type="button" id="auto_p_power" class="btn2 btn-secondary close-button" value="বন্ধ করুন" />
                    </p></td>
                </tr>
                </tbody>
            </table>
