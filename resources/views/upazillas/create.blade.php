...
<div class="card">
    <div class="card-header flex justify-between">
        <span class="text-2xl"> নতুন উপজেলা যুক্ত করুন</span>
        <a href="{{ route('upazillas.index') }}" class="btn btn-secondary">
            আগের পৃষ্ঠা
        </a>
    </div>
...
<form action="{{ route('upazillas.store') }}" method="POST" enctype="multipart/form-data">
    @csrf
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-6 col-md-6">
            <div class="form-group">
                <strong>জেলা:</strong>
                <select name="distid" id="district_id" class="form-control" size="1" title="অনুগ্রহ করে  জেলা বাছাই করুন">
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-6 col-md-6">
            <div class="form-group">
                ...
                <input type="text" name="upazillaname"  
