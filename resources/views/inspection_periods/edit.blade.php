...
<div class="card">
    <div class="card-header flex justify-between">
        <span class="text-2xl"> নতুন ইন্সপেকশন পিরিয়ড হালনাগাদ</span>
    ...
    <form action="{{ route('inspection_periods.update',$inspection_period->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
             ...
             <table>
                 <tbody>
                         ...
                         <td width="50%">ইন্সপেকশন পিরিয়ড<span style="color: red;"> * </span></td>
                                  ...
                                  value="{{$inspection_period->period_name }}" placeholder="ইন্সপেকশন পিরিয়ড" required>
                                  </td>
                         </tr>
                         <tr>
                             ...
                             <td class="input-append date" name="period_start_time" id="period_start_time">
                                ...
                                name="period_start_time" type="text" id="period_start_time"
                                value="{{$inspection_period->period_start_time}}" />
                                 <span class="add-on">
                         ...
                         <tr>
                             ...
                             <td><strong>:</strong></td>
                               <td class="input-append date" name="period_end_time" id="period_end_time">
                                  <input class="form-control" data-format="yyyy/MM/dd hh:mm:ss"
                                  name="period_end_time" type="text" id="period_end_time"
                                  value="{{$inspection_period->period_end_time}}"/>
                                    <span class="add-on">
                                    <i data-time-icon="icon-time" data-date-icon="icon-calendar"></i>
                                  </span>
                            </td>
                         ...
                         <tr>
                                <td>একটিভ </td>
                                <td><strong>:</strong></td>
                                <td><input type="checkbox" id="isActive"
                                {{ ( $inspection_period->isActive== 1) ? 'checked' : '' }}
                                  name="isActive" value="1"></td>
                            </tr>
