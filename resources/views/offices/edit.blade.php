...
<div class="card">
    <div class="card-header flex justify-between">
        <span class="text-2xl"> অফিস হালনাগাদ</span>
...
<form action="{{ route('offices.update',$office->office_id) }}" method="POST" enctype="multipart/form-data">
    @csrf
    @method('PUT')
    ...
    <div class="row">
       <div class="col-xs-12 col-sm-6 col-md-6">
           <div class="form-group">
               ...
               <input type="text" name="office_address" value="{{$office->office_address }}" 
        ...
        <div class="col-xs-12 col-sm-6 col-md-6">
            <div class="form-group">
                ...
                <select name="division_id" id="division_id" class="form-control" size="1" title="অনুগ্রহ করে  বিভাগ বাছাই করুন">
                    ...
                    <option value="{{ $division->divid}}" {{ $division->divid == $office->division_id ? 'selected' : '' }}>{{ $division->divname}}</option>
                    @endforeach
                </select>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-6 col-md-6">
            <div class="form-group">
                <strong>জেলা:</strong>
                <select name="district_id" id="district_id" class="form-control" size="1" 
                title="অনুগ্রহ করে  জেলা বাছাই করুন">
                    <option value="">জেলা</option>
                    @foreach($districts as $district)
                   <option value="{{ $district->distid}}" {{ $district->distid == $office->district_id ? 'selected' : '' }}>
       ...
       <div class="col-xs-12 col-sm-6 col-md-6">
           <div class="form-group">
               ...
               title="অনুগ্রহ করে উপজেলা বাছাই করুন">
                   ...
                   <option value="{{$upazilla->upazillaid}}" {{ $upazilla->upazillaid == $office->upazilla_id ? 'selected' : '' }}>
          ...
          <div class="form-group">
              ...
              <select name="office_type_id" id="office_type_id" class="form-control" size="1"
               title="অনুগ্রহ করে অফিস টাইপ বাছাই করুন">
                  ...
                  <option value="{{$office_type->office_type_id}}" {{ $office_type->office_type_id == $office->office_type_id ? 'selected' : '' }}>{{ $office_type->type_name}}</option>
                  @endforeach
              </select>
          </div>
      </div>
