...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header text-2xl">জেলা ও উপজেলা ইউজারের তথ্য হালনাগাদ</div>
                <div class="p-3 flex justify-between">

                    <form action="{{ route('editdisupzuserlist') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div>
                            <table>
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <select name="division_id" id="division_id3d" class="form-control" size="1"
                                        ...
                                        <td> জেলা</td><td>:</td>
                                        <td><select name="district_id" id="district_id3d"
                                        ...
                                        <td> ইউজার</td><td>:</td>
                                        <td><select name="user_id" id="user_id3d" class="form-control" 
                ...
                @if(!empty($user_id))
                <form method="post" action="{{route('users.update3',$user_id)}}"  enctype="multipart/form-data">
                    @csrf
                    @method('patch') 
