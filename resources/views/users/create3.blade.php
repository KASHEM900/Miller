        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header text-2xl flex justify-between">
                    <span>জেলা ইউজার তৈরি তথ্য</span>
                </div>
                ...
                <div class="card-body">
                    <div id="user_div">
                        ...
                        <fieldset>
                            {{-- <legend><b>জেলা ইউজার তৈরি তথ্য   <span style="color: gray;"> </span></b></legend> --}}
                            <form class="userform" action="createuser3" method="POST" enctype="multipart/form-data">
                                @csrf
                            <table>
                                <tbody>
                                <tr>
                                    ...
                                    <td><strong>:</strong> </td>
                                    <td>
                                        <select name="division_id" id="division_id3" class="form-control" size="1" title="অনুগ্রহ করে  বিভাগ বাছাই করুন" required="">
                                ...
                                <tr>
                                    ...
                                    <td><strong>:</strong></td>
                                    <td>
                                        <select name="district_id" id="district_id3" class="form-control" size="1" title="অনুগ্রহ করে  জেলা বাছাই করুন">
