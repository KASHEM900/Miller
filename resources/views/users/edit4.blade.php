...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header text-2xl">DGF ইউজারের তথ্য হালনাগাদ</div>
                <div class="p-3 flex justify-between">

                    <form action="{{ route('editdgflist') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div>
                            <table>
                                <tbody>
                ...
                @if(!empty($user_id))
                <form method="post" action="{{route('users.updatedgfuser',$user_id)}}"  enctype="multipart/form-data">
                    @csrf
                    @method('patch') 
