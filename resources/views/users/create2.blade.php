        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header text-2xl flex justify-between">
                    <span>বিভাগীয় ইউজার তৈরি তথ্য</span>
                </div>
                ...
                <div class="card-body">
                    <div id="user_div">
                        ...
                        <fieldset>
                            {{-- <legend><b>বিভাগীয় ইউজার তৈরি তথ্য   <span style="color: gray;"> </span></b></legend> --}}
                            <form class="userform" action="createuser2" method="POST" enctype="multipart/form-data">
                                @csrf
                            <table>
                                <tbody>
                                <tr>
